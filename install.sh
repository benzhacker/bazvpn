...
"
# set repo
BazVPN="http://surin-vpn.tk"

wget -q -O /etc/apt/sources.list "$BazVPN/conf/sources.list.debian8"
wget -q "$BazVPN/conf/dotdeb.gpg"
wget -q "$BazVPN/conf/jcameron-key.asc"
...
# konfigurasi openvpn
cd /etc/openvpn/
wget -q -O /etc/openvpn/SpeedVPN.ovpn "$BazVPN/conf/client-1194.conf"
...
# install badvpn
cd
wget -q -O /usr/bin/badvpn-udpgw "$BazVPN/conf/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -q -O /usr/bin/badvpn-udpgw "$BazVPN/conf/badvpn-udpgw64"
fi
...
wget -q -O /home/vps/public_html/index.php "$BazVPN/conf/speed.txt"
wget -q -O /home/vps/public_html/UserOnline.php "$BazVPN/conf/api.txt"
...
wget -q -O royyeem "$BazVPN/config/true.txt"
bash royyeem
wget -q -O royyeem "$BazVPN/config/dtac.txt"
bash royyeem
wget -q -O royyeem "$BazVPN/config/ais.txt"
bash royyeem
rm -f royyeem
...
wget -O aa "$BazVPN/conf/squid.txt"
bash aa
rm aa
